  ...
  return (
    <div className="w-full bg-white mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-extrabold text-[#1b3b34]">Tentang Kami</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col justify-center text-center lg:text-left">
          <h2 className="text-2xl sm:text-3xl lg:text-3xl font-bold text-[#1b3b34] mb-4">
        ...
        <div className="flex justify-center mt-6 lg:mt-0 w-full">
